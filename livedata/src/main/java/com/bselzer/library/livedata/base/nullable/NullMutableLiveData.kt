package com.bselzer.library.livedata.base.nullable
 ...
 */
open class NullMutableLiveData<Value>(initialValue: Value? = null, protected val defaultValue: Value? = null) : MutableLiveData<Value>(initialValue), Resettable
{
    /**
